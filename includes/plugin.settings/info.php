...
<div style="text-align: center;"><img src="<?php echo MYTIEIN_INFUS_SOCIAL_LOGIN_PLUGIN_URL ?>/screenshot-3.png" ></div>
...
<div style="text-align: center;"><img src="<?php echo MYTIEIN_INFUS_SOCIAL_LOGIN_PLUGIN_URL ?>/screenshot-1.png" ></div>
...
<div style="text-align: center;"><img src="<?php echo MYTIEIN_INFUS_SOCIAL_LOGIN_PLUGIN_URL ?>/screenshot-2.png" ></div>
...
<p style="margin-left:25px;margin:10px;"> 
	...
	<pre style="width: 400px;background-color: #FFFFE0;border:1px solid #E6DB55; border-radius: 3px;padding: 10px;margin-left:10px;"> &lt;?php do_action( 'mytiein_infusionsoft_social_login' ); ?&gt; </pre> 
</p>
</div>