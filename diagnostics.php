...
<head>
	...
	<title>MyTieIn Infusionsoft Social Login Requirements Test</title>
	<style>
...
<body>
	<h1 style="text-align:center;">MyTieIn Infusionsoft Social Login Requirements Test</h1>
...
<?php
	if ( isset( $_SESSION["wsl::plugin"] ) ){
		...
		<div style="background-color: #FFFFE0;border:1px solid #E6DB55; border-radius: 3px;padding: 15px;font-size: 12px;">  
			...
			<br />
			- wp-config.php<br />
			- wp-content/plugins/mytiein-infusionsoft-social-login/wp-social-login.php<br />
			- wp-content/plugins/mytiein-infusionsoft-social-login/authenticate.php<br />
			- wp-content/plugins/mytiein-infusionsoft-social-login/hybridauth/index.php<br />
		</div>
		<?php
	}
?>
